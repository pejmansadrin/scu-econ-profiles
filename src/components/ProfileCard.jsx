// src/components/ProfileCard.jsx (ویرایش شده برای لینک تمیز)
...
export default function ProfileCard({ user }) {
  ...
  // این آدرس، آدرس کامل فعلی (شامل /leaderboard/#ID) خواهد بود
  ...
  return (
    <div className="profile-page">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        {/* --- تغییر در اینجا --- */}
        <a href="/leaderboard" className="back-link d-inline-block"> {/* به جای href="#" */}
          <i className="bi bi-arrow-right"></i> بازگشت به لیدربورد
        </a>
        {/* --- پایان تغییر --- */}
